<?php get_header() ; ?>
    ...
    <section  class="cd-section hero-background page-hero contact-hero" style="background-image:  linear-gradient(176deg, rgba(0, 0, 0, 0.06), rgba(0, 0, 0, 0.42)), url('<?php the_post_thumbnail_url(); ?>')">
    ...
    <section class="contact-headline" id="contact-cont">
        <h2>Kontakt info</h2>
    </section>
